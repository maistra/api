...
var servicemeshextensionsResource = v1alpha1.SchemeGroupVersion.WithResource("servicemeshextensions")

var servicemeshextensionsKind = v1alpha1.SchemeGroupVersion.WithKind("ServiceMeshExtension")
